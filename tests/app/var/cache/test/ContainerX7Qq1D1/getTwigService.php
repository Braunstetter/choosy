 ...
 */
class getTwigService extends App_ChoosyBundleKernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 6).'/vendor/symfony/twig-bridge/Extension/DumpExtension.php';
        ...
        $a->addPath((\dirname(__DIR__, 4).'/templates'), '__main__');
        $a->addPath((\dirname(__DIR__, 6).'/src/Resources/views'), 'Media');
        $a->addPath((\dirname(__DIR__, 6).'/vendor/symfony/debug-bundle/Resources/views'), 'Debug');
        $a->addPath((\dirname(__DIR__, 6).'/vendor/symfony/debug-bundle/Resources/views'), '!Debug');
        ...
        $b = ($container->privates['debug.file_link_formatter'] ??= new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension(($container->services['var_dumper.cloner'] ?? $container->load('getVarDumper_ClonerService')), $d));
