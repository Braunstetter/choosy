 ...
 */
class App_ChoosyBundleKernelTestDebugContainer extends Container
{
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'debug.container.dump' => ($this->targetDir.''.'/App_ChoosyBundleKernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'DebugBundle' => [
                    'path' => (\dirname(__DIR__, 6).'/vendor/symfony/debug-bundle'),
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'App_ChoosyBundleKernelTestDebugContainer',
